...
/* 
    ...
    el chekbox sea de-seleccionado. Devuelve number[], en caso de que no existan elementos en el parámetro devolverá void,
    la función retorna number[] | void dependiendo su caso.
*/
